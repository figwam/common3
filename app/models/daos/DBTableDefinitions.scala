...
trait DBTableDefinitions {
  ...
  def model2entity(clazz: ClazzDefinition): DBClazzDefinition = DBClazzDefinition(None, asTimestamp(clazz.startFrom), asTimestamp(clazz.endAt), asTimestamp(clazz.activeFrom),asTimestamp(clazz.activeTill), clazz.name, clazz.recurrence+"", clazz.contingent, new Timestamp(System.currentTimeMillis), new Timestamp(System.currentTimeMillis),clazz.avatarurl,clazz.description,clazz.tags, None, clazz.idStudio.get, clazz.isActive, clazz.amount, clazz.vat, clazz.currency)
  def entity2model(clazz: DBClazzDefinition): ClazzDefinition = ClazzDefinition(clazz.id, asCalendar(clazz.startFrom), asCalendar(clazz.endAt), asCalendar(clazz.activeFrom), asCalendar(clazz.activeTill), Recurrence.withName(clazz.recurrence), clazz.name, clazz.contingent, clazz.avatarurl, clazz.description, clazz.tags, clazz.isActive, clazz.amount, clazz.vat, clazz.currency, Some(clazz.idStudio))
